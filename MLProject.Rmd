...
Following the initial split any rows which are included in the validation subset, but with users or movies which are not found in the training subset are moved out of validation and placed back into training. 
