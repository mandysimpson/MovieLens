...
This project, as part of the [HarvardX Professional Certificate in Data Science](https://www.edx.org/professional-certificate/harvardx-data-science) Capstone course, looks at how those recommendations are made, and in particular whether machine learning techniques can be used to improve predictions of the rating that a individual user will give to a particular movie. This is important to Netflix as it helps to generate the personalised recommendations presented to users (footnote - Netflix Tech blog https://medium.com/netflix-techblog/netflix-recommendations-beyond-the-5-stars-part-1-55838468f429).
...
image: ![](https://www.includehelp.com/ml-ai/Images/rmse-1.jpg)
...
```{r create_training_validation_subsets}
