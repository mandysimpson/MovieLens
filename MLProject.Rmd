...
The differences are large (given these are how far each average is from the overall average of `r round(average_rating,2)`) as shown in this histogram.
...
```{r calculate_lambda, results="hide", warning=FALSE, message=FALSE}
...
With the regularisation term added the RMSE has now fallen to `r regularisation_rmse`.
